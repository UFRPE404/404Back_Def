...
exports.getPlayerRecommendation = getPlayerRecommendation;
 ...
 */
async function getPlayerRecommendation(analysis) {
    if (!GROQ_API_KEY) {
    ...
    const response = await axios_1.default.post(GROQ_API_URL, {
        ...
        messages: [
            {
                role: "system",
                content: "Você é um analista esportivo profissional especializado em apostas de futebol. Responda sempre em português brasileiro, de forma objetiva e com dados numéricos.",
            },
