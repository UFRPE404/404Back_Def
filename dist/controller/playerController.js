...
exports.getLineup = exports.getPlayerConditionalAnalysis = exports.getPlayerBetRecommendation = exports.getPlayerAnalysis = exports.searchPlayerByName = void 0;
const betsApiService_1 = require("../services/betsApiService");
const player_analysis_service_1 = require("../services/player-analysis.service");
...
const getPlayerAnalysis = async (req, res) => {
    try {
        ...
        const apiResponse = await (0, betsApiService_1.getPlayerEvents)(id);
        const context = {
        ...
        const analysis = (0, player_analysis_service_1.analyzePlayerFromApiResponse)(apiResponse, context);
        res.json(analysis);
    }
    catch (error) {
...
exports.getPlayerAnalysis = getPlayerAnalysis;
/**
 * @swagger
 ...
 */
const getPlayerBetRecommendation = async (req, res) => {
    try {
        const { id } = req.params;
        if (!id) {
            res.status(400).json({ error: "player id é obrigatório" });
        ...
        const analysis = (0, player_analysis_service_1.analyzePlayerFromApiResponse)(apiResponse, context);
        const recommendation = await (0, llamaService_1.getPlayerRecommendation)(analysis);
...
exports.getPlayerBetRecommendation = getPlayerBetRecommendation;
/**
 * @swagger
 ...
 */
const getPlayerConditionalAnalysis = async (req, res) => {
    try {
        const { id } = req.params;
        if (!id) {
            res.status(400).json({ error: "player id é obrigatório" });
        ...
        const { isDerby, isHome, isOffensivePlayer, isDefensiveOpponent, expectedMinutes, match } = req.body;
        ...
        const apiResponse = await (0, betsApiService_1.getPlayerEvents)(id);
        const report = (0, player_analysis_service_1.analyzePlayerFull)(apiResponse, {
...
exports.getPlayerConditionalAnalysis = getPlayerConditionalAnalysis;
/**
 * @swagger
...
const getLineup = async (req, res) => {
    try {
        ...
        const lineup = await (0, betsApiService_1.getEventLineup)(eventId);
        res.json(lineup);
    }
    catch (error) {
